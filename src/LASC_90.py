...
def LASC_90():
    ...
    filename = os.path.join('Performance','data_folder', 'LA_90_10K_5-7-1_IADS.csv')
    ...
    hand_data = pd.read_excel(os.path.join('Performance','data_folder','LA_90_10K_5-7-1_hand_SAT.xlsx'))
